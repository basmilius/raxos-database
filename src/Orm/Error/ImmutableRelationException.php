...
/**
 * Class ImmutableRelationException
 *
 * @author Bas Milius <bas@mili.us>
 * @package Raxos\Database\Orm\Error
 * @since 2.0.0
 */
final class ImmutableRelationException extends Exception implements OrmExceptionInterface
{

    /**
     * ImmutableRelationException constructor.
     *
