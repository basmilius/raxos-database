...
/**
 * Class ImmutablePrimaryKeyException
 *
 * @author Bas Milius <bas@mili.us>
 * @package Raxos\Database\Orm\Error
 * @since 2.0.0
 */
final class ImmutablePrimaryKeyException extends Exception implements OrmExceptionInterface
{

    /**
     * ImmutablePrimaryKeyException constructor.
     *
